...
namespace Turisticka_Agencija.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            HttpContext.Application["dpmin"] = sortiraniAranzmani[sortiraniAranzmani.Keys.First()].datumPocetkaPutovanja.ToString("yyyy-MM-dd");
            HttpContext.Application["dpmax"] = sortiraniAranzmani[sortiraniAranzmani.Keys.Last()].datumPocetkaPutovanja.ToString("yyyy-MM-dd");
            HttpContext.Application["dkmin"] = sortiraniAranzmani[sortiraniAranzmani.Keys.First()].datumZavrsetkaPutovanja.ToString("yyyy-MM-dd");
            HttpContext.Application["dkmax"] = sortiraniAranzmani[sortiraniAranzmani.Keys.Last()].datumZavrsetkaPutovanja.ToString("yyyy-MM-dd");
